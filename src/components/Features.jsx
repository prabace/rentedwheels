    ...
    <div className='w-full  mt-56'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
            <div className='bg-white rounded-xl shadow-2xl'>
                ...
                <h3 className='text-3xl mt-5 font-semibold'>Fast & Easy Booking</h3>
                ...
                <button className='px-5 py-3 mt-5 rounded-full bg-[#f9a826] border-[#f9a826] hover:text-[#f9a826]'>Book Now<></></button>
                </div>
            </div>
            ...
            <div className='bg-white rounded-xl shadow-2xl'>
                ...
                <h3 className='text-3xl mt-5 font-semibold'>Extensive Vehicle Choices</h3>
                <p className='mt-5'>We provide wide range of different varities of vehciles. Choose one that suits you the best.</p>
                <button className='px-5 py-3 mt-5 rounded-full bg-[#f9a826] border-[#f9a826] hover:text-[#f9a826]'>Expore Options</button>
                </div>
            </div>
            ...
            <div className='bg-white rounded-xl shadow-2xl'>
                ...
                <h3 className='text-3xl mt-5 font-semibold'>Satisfied Costumers</h3>
