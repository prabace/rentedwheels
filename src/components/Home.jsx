...
function Home() {
  return (
    ...
    <div className=' w-full h-screen static '>
       ...
       <div className='w-full h-full absolute top-0 flex flex-col justify-center text-left md:text-6xl lg:text-6xl text-4xl font-semibold font-body text-black p-9 mx-5 '>
