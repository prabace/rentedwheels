...
function Users({history}) {
  ...
  const displayCard= Object.keys(vehicleData).filter(function(el){
    return vehicleData[el].username===localusername
  })
  const display =
    displayCard.map(keys => <Carcard price={vehicleData[keys].vehiclePrice}
